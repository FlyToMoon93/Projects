...
const Layout: React.FC<{ children: React.ReactNode }> = ({ children }) => {
    ...
    // Mock: Fetch new notifications every few seconds (or replace with actual API calls/WebSocket)
    useEffect(() => {
        const interval = setInterval(() => {
            setNotificationCount(prevCount => prevCount + 1); // Increment the count
        }, 10000); // Update every 10 seconds for example purposes
    ...
    return (
        ...
        >
            ...
            <Collapse in={isSidebarOpen} timeout="auto" unmountOnExit ref={sidebarRef}>
                <Box
                    sx={{
