...
*/
#define pathname "/home/watchdog/watchdog/watchdog/headers"
/**
 * Please provide the correct path for the config.h file if you wish to enable "SHOW_CONFIG_FILE" option.
  */
#define CONFIG_FILE_PATH "//home/watchdog/watchdog/watchdog/headers/config.h"
...
*/
#define START_TIMEOUT_ERROR  false
#define START_TEMPERATURE_ERROR false
#define START_DEADLOCK   true
